...
/*Classes abstraites et pas interfaces, parce que c'est la définition du fonctionement interne de ces classes, pas de la façon dont elles sont utilisées par d'autres objets. On veut limiter l'accès autant que possible.
